import { boolean, index, integer, PgColumn, pgEnum, pgTable, PgTableWithColumns, text, timestamp, varchar } from "drizzle-orm/pg-core";
...
export const jobListingTypes = ["internship", "full-time", "part-time"] as const;
